...
const projects = [
  ...
  new Project("Bootstrap Sprint", "HTML, CSS, Bootstrap", "It was incredible to see how effective Bootstrap is at providing proffesionally styled websites, which could easily be customized for a specific need. This project was not only fun, but opened up a world of possibilities in my mind for future developing.", "https://github.com/IDHalverson/assignment_bootstrap_sprint", "/images/Bootstrap.png"),
  new Project("Project Prep Facebook Pages", "HTML, CSS", "This project was huge muscle-flexer in both CSS and HTML. It allowed me to learn (through experience) a lot about organizing code well, re-using code/styling on multiple pages, and using CSS classes verses ID. It kinda makes want to start my own Facebook.com!", "https://github.com/IDHalverson/project_prep_facebook_pages", "/images/Facebook.png"),
